...
public class Literal {
	...
	public void release() {
		for(int i=0; i<FLogicConstants.MAX_ARITY; i++) args[i]=null; args=null;
		for(Map.Entry me : atts.entrySet()) {Atom atm = (Atom) me.getValue(); atm = null;} atts.clear(); atts=null;
		for(Literal lit : disjuncts) {lit.release(); lit=null;}
		disjuncts.clear(); disjuncts=null;
	}
	...
	public String toNormalizedString() {
		...
		for(int a=0; a<getArity(); a++)
			...
			else {sb.append("_"); sb.append(getArgs()[a].getLabel());}
		return sb.toString();
	}
